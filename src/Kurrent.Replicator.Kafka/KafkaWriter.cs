...
public class KafkaWriter : IEventWriter {
    ...
    public Task<long?> GetLastPosition(CancellationToken cancellationToken) => throw new NotImplementedException();
    public Task<LogPosition> GetLastFullPosition(CancellationToken cancellationToken) => throw new NotImplementedException();
