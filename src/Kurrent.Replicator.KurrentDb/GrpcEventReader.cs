...
public class GrpcEventReader : GrpcEventPositionReader, IEventReader {
    ...
    public GrpcEventReader(EventStoreClient client) : base(client) {
    ...
    public async Task ReadEvents(LogPosition fromLogPosition, Func<BaseOriginalEvent, ValueTask> next, CancellationToken cancellationToken) {
        ...
        var read = base._client.ReadAllAsync(Direction.Forwards, new(eventPosition, eventPosition), cancellationToken: cancellationToken);
        ...
        do {
            ...
            if(ReplicationMetrics.ReadsHistogram is null) {
